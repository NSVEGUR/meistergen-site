...
import { AnimatedBeam } from "@/components/misc/animated-beam";
...
Circle.displayName = "Animated Beam";
...
export function ProductsBeam() {
  ...
  return (
    <div
      className="relative flex h-full w-full max-w-[32rem] mx-auto items-center justify-center overflow-hidden bg-background p-10 md:shadow-xl"
      ref={containerRef}
    >
